        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('updateall/'.$data->id) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" value="{{ $data->firstname }}" class="form-control @error('firstname') is-invalid @enderror" name="firstname" required autocomplete="firstname" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="address" value="" class="col-md-4 col-form-label text-md-right">{{ __('Address') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="text" class="form-control @error('number') is-invalid @enderror" name="number" value="{{ $data->number }}" required autocomplete="number">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="experience" class="form-control @error('experience') is-invalid @enderror" name="experience" required autocomplete="experience" autofocus>{{ $data->experience }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="position" type="text" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ $data->position }}" required autocomplete="position">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="salary" type="text" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ $data->salary }}" required autocomplete="salary">
